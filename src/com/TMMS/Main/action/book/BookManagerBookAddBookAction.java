...
public class BookManagerBookAddBookAction extends ActionSupport{
	...
	public String execute() throws Exception {
		...
		if(UsersService.haveCollegePurview()){
			...
			booksService.bookManagerAddBook(username, BName, BAuthor, BPrice, BIsbn, BPress, BOrder, BPlan, BBorders, BGrand);
			return SUCCESS;
		}
		return ERROR;
	}
